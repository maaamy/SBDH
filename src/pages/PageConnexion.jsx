      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-10 bg-connexionBgImg bg-cover bg-center bg-no-repeat">
        ...
        <div className="bg-button-5-hover/15 backdrop-blur-sm rounded-2xl px-24 py-16 flex flex-col items-center gap-8">
          ...
          <div className="text-center">
            ...
            <h1 className="titleText text-black mb-2">Connexion</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-center justify-center">
            ...
            <RoleCard
              ...
              primaryAction={() => navigate("/connexion/client")}
              secondaryLabel="S'inscrire"
              secondaryAction={() => navigate("/inscription/client")}
              linkLabel="Pas encore de compte ?"
              linkAction={() => navigate("/inscription/client")}
            />

            <RoleCard
              title="En tant qu'entreprise"
              primaryLabel="Se connecter"
              primaryAction={() => navigate("/connexion/entreprise")}
              secondaryLabel="S'inscrire"
              secondaryAction={() => navigate("/inscription/entreprise")}
              linkLabel="Pas encore de compte ?"
              linkAction={() => navigate("/inscription/entreprise")}
            />
