...
const ProductCard = ({product, purchase=true}) => {
  ...
  return (
    <div className="bg-bg flex flex-col items-center gap-3 w-56 h-80 shrink-0 py-2 px-4 hover:shadow-md transition-shadow cursor-pointer"
    ...
    >
      ...
      <p className="productTitle text-product text-center flex-1">
        {product.nom}
      </p>
      ...
      { purchase && (
        <button
          className="buttonText w-full h-10 bg-color-button text-white hover:bg-button-hover active:scale-95 transition-all mt-auto"
